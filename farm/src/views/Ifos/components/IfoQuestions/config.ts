const config = [
  ...
  },
  {
    ...
    description: [
      'You can choose one or both at the same time! If you’re only committing a small amount, we recommend the Basic Sale first. Just remember you need a UbuntuSwap Profile in order to participate.',
    ],
  },
  {
